...
function PedidoContent() {
  ...
  async function enviarPedido(e: React.FormEvent) {
            ...
            const payload = {
                        ...
                        ...(est?.id ? { estabelecimento_id: est.id } : {}),
            }
            ...
            return (
                        <div className="min-h-screen bg-amber-50 flex items-center justify-center p-4">
                                <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full text-center">
                                          <div className="text-6xl mb-4">OK</div>div>
                                          <h1 className="text-2xl font-bold text-green-600 mb-2">Pedido Confirmado!</h1>h1>
                                          <p className="text-gray-600 mb-4">Seu pedido foi recebido.</p>p>
        ...
        return (
                  <div className="min-h-screen bg-amber-50 p-4">
                        <div className="max-w-lg mx-auto">
                                <div className="mb-6">
                                          <h1 className="text-2xl font-bold text-amber-800">{est?.nome || 'Finalizando Pedido'}</h1>h1>
